package org.jeecg.modules.mis.material.service.impl;
...
import org.jeecg.modules.mis.material.mapper.MaterialMapper;
...
public class MaterialServiceImpl extends ServiceImpl<MaterialMapper, Material> implements IMaterialService {
	...
	private void updateOldParentNode(String pid) {
		if(!IMaterialService.ROOT_PID_VALUE.equals(pid)) {
			Long count = baseMapper.selectCount(new QueryWrapper<Material>().eq("pid", pid));
