...
<script lang="ts" name="material-material" setup>
  ...
  import {columns, searchFormSchema, superQuerySchema} from './Material.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteMaterial, batchDeleteMaterial, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './Material.api';
  ...
  async function handleDelete(record) {
    await deleteMaterial({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteMaterial({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
