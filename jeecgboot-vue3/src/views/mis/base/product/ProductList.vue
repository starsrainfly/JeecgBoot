<template>
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection" :expandedRowKeys="expandedRowKeys" @expand="handleExpand" @fetch-success="onFetchSuccess">
      <!--插槽:table标题-->
      <template #tableTitle>
          <a-button type="primary" v-auth="'product:mis_product:add'" @click="handleCreate" preIcon="ant-design:plus-outlined"> 新增</a-button>
...
<script lang="ts" name="product-product" setup>
  ...
  import {columns, searchFormSchema, superQuerySchema} from './Product.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteProduct, batchDeleteProduct, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './Product.api';
  ...
  async function handleDelete(record) {
    await deleteProduct({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteProduct({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
