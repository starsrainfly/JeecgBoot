<template>
  <BasicModal v-bind="$attrs" @register="registerModal" destroyOnClose :width="1280" :title="getTitle" @ok="handleSubmit">
    <BasicForm @register="registerForm" name="ProductForm" />
  </BasicModal>
</template>
<script lang="ts" setup>
  ...
  import {loadTreeData, saveOrUpdateDict} from '../Product.api';
  // 获取emit
