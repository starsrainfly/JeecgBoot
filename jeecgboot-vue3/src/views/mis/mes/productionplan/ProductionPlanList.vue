<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          <a-button type="primary" v-auth="'mes:mis_production_plan:add'"  @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增</a-button>
          <a-button  type="primary" v-auth="'mes:mis_production_plan:exportXls'"  preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
          <j-upload-button  type="primary" v-auth="'mes:mis_production_plan:importExcel'"  preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
          <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'mes:mis_production_plan:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <ProductionPlanModal @register="registerModal" @success="handleSuccess"></ProductionPlanModal>
  </div>
</template>

<script lang="ts" name="mes-productionPlan" setup>
  ...
  function getDropDownAction(record){
    ...
    return [
      ...
      },
      {
        ...
        auth:'mes:mis_production_plan:publish'
      },
    ]
  }
