...
<script lang="ts" name="scm-salesOrder" setup>
  ...
  import SalesOrderModal from './components/SalesOrderFinanceApproveModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './SalesOrderFinanceApprove.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './SalesOrderFinanceApprove.api';
