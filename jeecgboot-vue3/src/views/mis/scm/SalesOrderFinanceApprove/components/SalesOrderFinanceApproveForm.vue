    ...
    <a-tabs v-model:activeKey="activeKey" animated  @change="handleChangeTabs">
      <a-tab-pane tab="销售订单明细表" key="salesOrderDetail" :forceRender="true">
        <JVxeTable
          ...
          v-if="salesOrderDetailTable.show"
...
<script lang="ts">
  ...
  import {getBpmFormSchema,salesOrderDetailColumns} from '../SalesOrderFinanceApprove.data';
  import {saveOrUpdate,salesOrderDetailList} from '../SalesOrderFinanceApprove.api';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      async function initFormData(){
        ...
        requestSubTableData(salesOrderDetailList, {id: data.id}, salesOrderDetailTable, ()=>{
          salesOrderDetailTable.show = true;
        });
        //默认是禁用
