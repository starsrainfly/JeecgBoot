...
<script lang="ts" setup>
    ...
    import {formSchema,salesOrderDetailColumns} from '../SalesOrderFinanceApprove.data';
    import {saveOrUpdate,salesOrderDetailList, financeApprove} from '../SalesOrderFinanceApprove.api';
