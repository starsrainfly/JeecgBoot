...
<script lang="ts" name="scm-salesOrder" setup>
  ...
  import SalesOrderModal from './components/SalesOrderSalesApproveModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './SalesOrderSalesApprove.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './SalesOrderSalesApprove.api';
