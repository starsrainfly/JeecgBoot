...
<script lang="ts">
  ...
  import {getBpmFormSchema,salesOrderDetailColumns} from '../SalesOrderSalesApprove.data';
  import {saveOrUpdate,salesOrderDetailList} from '../SalesOrderSalesApprove.api';
