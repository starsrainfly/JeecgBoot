...
<script lang="ts" setup>
    ...
    import {formSchema,salesOrderDetailColumns} from '../SalesOrderSalesApprove.data';
    import {saveOrUpdate,salesOrderDetailList, salesApprove} from '../SalesOrderSalesApprove.api';
