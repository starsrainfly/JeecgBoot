...
<script lang="ts" name="scm-customer" setup>
  ...
  import CustomerModal from './components/MyCustomerModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './MyCustomer.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './MyCustomer.api';
