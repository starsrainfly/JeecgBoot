...
<script lang="ts">
  ...
  import {getBpmFormSchema,customerAddressColumns,customerQualificationColumns,customerContactColumns,customerSalesmanColumns} from '../MyCustomer.data';
  import {saveOrUpdate,customerAddressList,customerQualificationList,customerContactList,customerSalesmanList} from '../MyCustomer.api';
