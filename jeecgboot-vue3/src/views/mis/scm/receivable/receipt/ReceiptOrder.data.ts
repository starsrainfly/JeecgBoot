...
export const formSchema: FormSchema[] = [
  // ==================== 基本信息分组 ====================
  {
    label: '基本信息',
    field: 'group_basic',
    component: 'Divider',  // 使用分割线作为分组标题
    colProps: { span: 24 },
    componentProps: {
      orientation: 'left',
      style: { fontWeight: 'bold', color: '#1890ff', marginTop: '8px',      // 默认是 24px，改小
        marginBottom: '8px',    // 默认是 24px，改小
         }
    }
  },
  {
  ...
  // ==================== 收款信息分组 ====================
  {
    ...
    componentProps: {
      orientation: 'left',
      style: { fontWeight: 'bold', color: '#1890ff', marginTop: '16px' }
    }
  },
  {
    label: '收款日期',
