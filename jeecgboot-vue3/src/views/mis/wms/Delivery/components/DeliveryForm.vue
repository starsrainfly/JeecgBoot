...
<script lang="ts">
  ...
  import {getBpmFormSchema,deliveryDetailColumns} from '../Delivery.data';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      const queryByIdUrl = '/wms/delivery/queryById';
      async function initFormData(){
        let params = {id: props.formData.dataId};
        const data = await defHttp.get({url: queryByIdUrl, params});
        //设置表单的值
        await setFieldsValue({...data});
        requestSubTableData(deliveryDetailList, {id: data.id}, deliveryDetailTable, ()=>{
          deliveryDetailTable.show = true;
        });
        //默认是禁用
