...
<script lang="ts" name="wms-stockIn" setup>
  ...
  import StockInModal from './components/ProductInModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './ProductIn.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './ProductIn.api';
