...
<script lang="ts" name="wms-stockIn" setup>
  ...
  import StockInModal from './components/ProductInApproveModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './ProductInApprove.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './ProductInApprove.api';
