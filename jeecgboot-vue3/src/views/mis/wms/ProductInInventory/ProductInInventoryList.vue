...
<script lang="ts" name="wms-stockIn" setup>
  ...
  import StockInModal from './components/ProductInInventoryModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './ProductInInventory.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './ProductInInventory.api';
