...
export const formSchema: FormSchema[] = [
  ...
  { label: '明细IDs', field: '_detailIds', component: 'Input', show: false },
  { label: '产品IDs', field: '_productIds', component: 'Input', show: false },
  { label: '产品编码', field: '_productCodes', component: 'Input', show: false },
  { label: '产品名称', field: '_productNames', component: 'Input', show: false },
  { label: '规格', field: '_productSpecs', component: 'Input', show: false },
  { label: '颜色', field: '_productColors', component: 'Input', show: false },
  { label: '单位', field: '_units', component: 'Input', show: false },
  { label: '剩余数量', field: '_remainQtys', component: 'Input', show: false },
  { label: '单价', field: '_unitPrices', component: 'Input', show: false },
  { label: '包装ID', field: '_packageIds', component: 'Input', show: false },
  { label: '包装名称', field: '_packageNames', component: 'Input', show: false },
  { label: '备注', field: '_remarks', component: 'Input', show: false },
  {
    label: '销售订单号',
    ...
    componentProps: ({ formActionType }) => {
      ...
      return{
        setFieldsValue:setFieldsValue,
        code:"scm_sales_order_for_outStore",
        fieldConfig: [
          { source: 'id', target: 'sourceOrderId' },
          { source: 'order_no', target: 'sourceOrderCode' },
          ...
          {source: 'delivery_address',target: 'deliverAddress'},
          { source: 'company_id', target: 'companyId' },
          { source: 'company_code', target: 'companyCode' },      // 建议加
          { source: 'company_name', target: 'companyName' },
          // === 明细字段（用于拆分组装子表）===
          { source: 'order_detail_id', target: '_detailIds' },
          { source: 'product_id', target: '_productIds' },
          { source: 'product_code', target: '_productCodes' },
          { source: 'product_name', target: '_productNames' },
          { source: 'product_spec', target: '_productSpecs' },
          { source: 'product_color', target: '_productColors' },
          { source: 'unit', target: '_units' },
          { source: 'remain_qty', target: '_remainQtys' },
          { source: 'unit_price', target: '_unitPrices' },
          { source: 'package_id', target: '_packageIds' },
          { source: 'package_name', target: '_packageNames' },
          { source: 'remark', target: '_remarks' },
        ],
        multi:true
      }
    },
