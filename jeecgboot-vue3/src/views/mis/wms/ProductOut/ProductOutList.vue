...
<script lang="ts" name="wms-stockOut" setup>
  ...
  import StockOutModal from './components/ProductOutModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './ProductOut.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './ProductOut.api';
