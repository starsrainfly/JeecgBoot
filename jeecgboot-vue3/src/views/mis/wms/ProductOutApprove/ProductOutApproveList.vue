...
<script lang="ts" name="wms-stockOut" setup>
  ...
  import StockOutModal from './components/ProductOutApproveModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './ProductOutApprove.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './ProductOutApprove.api';
