...
<script lang="ts" name="wms-stockOut" setup>
  ...
  import StockOutModal from './components/ProductOutInventoryModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './ProductOutInventory.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './ProductOutInventory.api';
  ...
  const { prefixCls,tableContext,onExportXls,onImportXls } = useListPage({
      tableProps:{
           ...
           beforeFetch: (params) => {
             return Object.assign(params, queryParam,{isProduct:'1'});
           },
        },
        exportConfig: {
            name:"出库表",
